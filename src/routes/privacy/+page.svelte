<svelte:head>
  ...
  <link rel="canonical" href="https://offmarketprime.co.uk/cookie-policy" />
</svelte:head>
  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white rounded-lg shadow-sm p-8">
      ...
      <div class="prose max-w-none">
        <h2>Introduction</h2>
        <p>
          Welcome to OffMarketPrime privacy notice.
        </p>
        <p>
        ...
        <h3>Controller</h3>
        <p>
          OffMarketPrime is the controller and responsible for your personal data (collectively referred to as "we", "us" or "our" in this privacy notice).
        </p>
        <p>
        ...
        <ul>
          <li><strong>Identity Data</strong> includes first name(s), last name, username or similar identifier, title and gender.</li>
          <li><strong>Contact Data</strong> includes postal address, email address and telephone numbers.</li>
        ...
        <ul>
          ...
          <li><strong>Third parties or publicly available sources.</strong> We may receive personal data about you from various third parties and public sources as set out below:
            <ul>
              ...
              <li>Contact and Transaction Data from providers of technical and delivery services.</li>
        ...
        <ul>
          <li>Where we need to respond to your requests for information.</li>
          <li>Where it is necessary for our legitimate interests (or those of a third party) and your interests and fundamental rights do not override those interests.</li>
          <li>Where we need to comply with a legal or regulatory obligation.</li>
        </ul>
        <p>
          We rely on consent as a legal basis for processing your personal data in relation to sending marketing communications to you via email, post, push notification, text message, RCS or WhatsApp. You have the right to withdraw consent to marketing at any time by contacting us.
        </p>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full bg-white border border-gray-300 text-sm">
            <thead class="bg-gray-50">
              <tr>
                <th class="border border-gray-300 px-4 py-2 text-left font-medium">Purpose/Activity</th>
                <th class="border border-gray-300 px-4 py-2 text-left font-medium">Type of Data</th>
                <th class="border border-gray-300 px-4 py-2 text-left font-medium">Lawful Basis for Processing</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="border border-gray-300 px-4 py-2">To register you as a new user</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact</td>
                <td class="border border-gray-300 px-4 py-2">Performance of a contract with you</td>
              </tr>
              <tr class="bg-gray-50">
                <td class="border border-gray-300 px-4 py-2">To process and deliver the information requested by you</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact<br/>(c) Marketing and Communications</td>
                <td class="border border-gray-300 px-4 py-2">Performance of a contract with you</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">To manage our relationship with you which will include:<br/>(a) Notifying you about changes to our terms or privacy policy<br/>(b) Asking you to leave a review or take a survey</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact<br/>(c) Profile<br/>(d) Marketing and Communications</td>
                <td class="border border-gray-300 px-4 py-2">(a) Performance of a contract with you<br/>(b) Necessary to comply with a legal obligation<br/>(c) Necessary for our legitimate interests (to keep our records updated and to study how customers use our products/services)</td>
              </tr>
              <tr class="bg-gray-50">
                <td class="border border-gray-300 px-4 py-2">To enable you to partake in a prize draw, competition or complete a survey</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact<br/>(c) Profile<br/>(d) Usage<br/>(e) Marketing and Communications</td>
                <td class="border border-gray-300 px-4 py-2">(a) Performance of a contract with you<br/>(b) Necessary for our legitimate interests (to study how customers use our products/services, to develop them and grow our business)</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">To administer and protect our business and this website (including troubleshooting, data analysis, testing, system maintenance, support, reporting and hosting of data)</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact<br/>(c) Technical</td>
                <td class="border border-gray-300 px-4 py-2">(a) Necessary for our legitimate interests (for running our business, provision of administration and IT services, network security, to prevent fraud and in the context of a business reorganisation or group restructuring exercise)<br/>(b) Necessary to comply with a legal obligation</td>
              </tr>
              <tr class="bg-gray-50">
                <td class="border border-gray-300 px-4 py-2">To deliver relevant website content and advertisements to you and measure or understand the effectiveness of the advertising we serve to you</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact<br/>(c) Profile<br/>(d) Usage<br/>(e) Marketing and Communications<br/>(f) Technical</td>
                <td class="border border-gray-300 px-4 py-2">Necessary for our legitimate interests (to study how customers use our products/services, to develop them, to grow our business and to inform our marketing strategy)</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">To use data analytics to improve our website, products/services, marketing, customer relationships and experiences</td>
                <td class="border border-gray-300 px-4 py-2">(a) Technical<br/>(b) Usage</td>
                <td class="border border-gray-300 px-4 py-2">Necessary for our legitimate interests (to define types of customers for our products and services, to keep our website updated and relevant, to develop our business and to inform our marketing strategy)</td>
              </tr>
              <tr class="bg-gray-50">
                <td class="border border-gray-300 px-4 py-2">To make suggestions and recommendations to you about goods or services that may be of interest to you</td>
                <td class="border border-gray-300 px-4 py-2">(a) Identity<br/>(b) Contact<br/>(c) Technical<br/>(d) Usage<br/>(e) Profile</td>
                <td class="border border-gray-300 px-4 py-2">Necessary for our legitimate interests (to develop our products/services and grow our business)</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <ul>
          <li>Internal Third Parties as set out in the Glossary at the end.</li>
          <li>External Third Parties as set out in the Glossary at the end.</li>
        ...
        <p>
          We keep your enquiry details for a maximum of 12 months from the date of your last interaction, after which they are securely deleted or anonymised, unless we are required by law to keep them longer (for example, for fraud prevention or legal claims).
        </p>
        <p>
        ...
        <ul>
          <li>Service providers acting as processors who provide IT and administration services.</li>
          ...
          <li>HM Revenue & Customs, regulators and other authorities acting as processors or joint controllers based who require reporting of processing activities in certain circumstances.</li>
        </ul>
